...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self,*args, **kwargs):
        ...
        self.fields['password1'].help_text = '<ul class="form-text text-muted"><li>your password cant be similar to the other personal information</li><li>your password least 8 characters</li><li>your password cantbe</li><li>only numeric</li> </ul>'
